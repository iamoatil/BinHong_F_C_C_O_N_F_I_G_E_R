...
CFC_ConfigerApp::CFC_ConfigerApp()
{
	// 支持重新启动管理器
...
// 唯一的一个 CFC_ConfigerApp 对象

CFC_ConfigerApp theApp;


// CFC_ConfigerApp 初始化

BOOL CFC_ConfigerApp::InitInstance()
{
	...
	Sleep(1000); //Delay 3 Second//自定显示启动画面的时间
